...
export default function Alpha() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const response = await fetch('/api/submission', {
      ...
      body: JSON.stringify({
        taskId: 'Bugatti',  // Replace with actual task ID
    ...
    <section>
      <div className="flex flex-col justify-center items-center">
        <div className="max-w-7xl mx-auto text-center my-32">
          <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">Bugatti</h1>
        ...
        <div className="md:grid md:grid-cols-12 md:gap-6 items-center my-32">
          {/* Image */}
          <ImageSection src="https://ds-security-web.s3.amazonaws.com/ui/media/images/bugatti.jpg" alt="beerus Image"width={450} height={305} />
          <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
            <div className="md:pl-4 lg:pl-12 xl:pl-16">
            <Link href={session?.user ? "https://drive.proton.me/urls/ZE22FBJY5R#utPJ5UAxXVS3" :"/signin"} target={session?.user ? "_blank" : ""}>
