    ...
    <section>
      <div className="flex flex-col justify-center items-center">
        <div className="max-w-7xl mx-auto text-center my-32">
          <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-7xl">Skyline</h1>
        ...
        <div className="md:grid md:grid-cols-12 md:gap-6 items-center my-32">
          {/* Image */}
          <ImageSection src="https://ds-security-web.s3.amazonaws.com/ui/media/images/skyline.jpg" alt="beerus Image" width={540} height={405} />
