    ...
    <section>
      <div className="flex flex-col justify-center items-center">
        <div className="max-w-7xl mx-auto text-center my-32">
          <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-7xl">Head2</h1>
        ...
        <div className="md:grid md:grid-cols-12 md:gap-6 items-center my-32">
          {/* Image */}
          <ImageSection src="https://ds-security-web.s3.amazonaws.com/ui/media/images/head2.jpg" alt="beerus Image" width={540} height={405} />
          <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
            ...
            <Link href={session?.user ? "https://drive.proton.me/urls/WPH7XWXC98#TTfaL1aFH4Qm" :"/signin"} target={session?.user ? "_blank" : ""}>
                  ...
                  <div className="font-e text-4xl font-bold text-green-600 mb-2">No Sweat</div> 
