    ...
    <section>
      <div className="flex flex-col justify-center items-center">
        <div className="max-w-7xl mx-auto text-center my-32">
          <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-6xl">Beerus</h1>
        ...
        <div className="md:grid md:grid-cols-12 md:gap-6 items-center my-32">
          {/* Image */}
          <ImageSection src="https://ds-security-web.s3.amazonaws.com/ui/media/images/beerus.png" alt="beerus Image"width={420} height={305} />
          <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
            ...
            <Link href={session?.user ? "https://drive.proton.me/urls/KHBQ74705M#zSkENqj3Pbqr" :"/signin"} target={session?.user ? "_blank" : ""}>
                  ...
                  <div className="font-e text-3xl font-bold text-purple-600 mb-2">No Sweat</div>
                  <h3 className="h3 text-2xl mb-3">Click to download
                  <FaDownload className=""/>
              </h3>
                </Link>
              
              <p className="leading-7 text-l mr-56 mb-3 [&:not(:first-child)]:mt-6">Download the OVA file, import it into our virtual machine environment, start the machine, and run</p>
